...
**Phase 2 — photos.** Add an item with a photo from the camera or library,
browse and filter the closet, edit or delete an item (its photos and match
records go with it), replace a photo, and rate pairs as match/dismatch either
from an item or through the Speed Matcher.
