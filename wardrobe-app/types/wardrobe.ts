...
export interface ClothingItem {
  ...
  /**
   * How warm the garment is, 1-5, or 0 for not yet assessed.
   *
   * Generated by the app from Phase 3 onwards, not asked of the user. Enforced
   * by a CHECK constraint; see SCALE_MAX in utils/format.ts.
   */
  inferredWarmth: number;
  /** How windproof the garment is, on the same 1-5 scale. 0 means unassessed. */
  inferredWind: number;
  wearCount: number;
  createdAt: string;
}
